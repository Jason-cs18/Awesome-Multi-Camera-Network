...
- Multi-camera Networks research notes. **Target venues**: network conferences (*NSDI/SIGCOMM*), mobile conferences (*MobiCom/MobiSys/SenSys/UbiComp*) and computer vision conferences (*ICCV/CVPR/ECCV/ICML/ICLR/NeurIPS*).
