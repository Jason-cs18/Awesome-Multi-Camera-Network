...
- Multi-camera Networks research notes. **Target venues**: network (*NSDI/SIGCOMM/SoCC*), mobile (*MobiCom/MobiSys/SenSys/UbiComp*), data analytics (*VLDB/SIGMOD*) and computer vision (*ICCV/CVPR/ECCV/ICML/ICLR/NeurIPS*).
