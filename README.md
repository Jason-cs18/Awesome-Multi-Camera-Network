...
4. [COS 598a: Machine Learning-Driven Video Systems (Spring 2022, Princeton)](https://ml-video-seminar.princeton.systems/index.html) - target to recent research interests on video analytics (_Strong Recommendation_)
...
8. [CS6465: Emerging Cloud Technologies and Systems Challenges (Fall 2019, Cornell)](https://www.cs.cornell.edu/courses/cs6465/2019fa/) - emerging cloud computing technology, opportunities and challenges.
## Topics
### System
...
[7] [Schelter et al. Learning to Validate the Predictions of Black Box Classifiers on Unseen Data. In *SIGMOD'20*.](https://dl.acm.org/doi/abs/10.1145/3318464.3380604) - a tool to monitor models' performance without annotations<br>
