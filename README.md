...
- Multi-camera Networks research notes. **Target venues**: network conferences (*NSDI/SIGCOMM/SoCC*), mobile conferences (*MobiCom/MobiSys/SenSys/UbiComp*), data analytics conferences (*VLDB/SIGMOD*) and computer vision conferences (*ICCV/CVPR/ECCV/ICML/ICLR/NeurIPS*).
...
2. [706.550: Architecture of ML Systems (Fall 2021, Graz University of Technology)](https://mboehm7.github.io/teaching/ss21_amls/index.htm) - the architecture and essential concepts of modern ML systems for both local and large-scale machine learning (based on non-deep ML analytics)
